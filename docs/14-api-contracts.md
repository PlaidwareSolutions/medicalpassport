...
| `GET/DELETE /reports/:id` | Detail (attached documents) / soft delete. Deleting never cascades — documents keep their `report_id` and stay downloadable on their own id. |
