/**
 * Finding-type vocabulary and presentation constants shared with clients
 * (which render findings but never compute them).
 */
...
export const FINDING_TITLE_KEYS: Record<SafetyFindingCategory, string> = {
  ...
  multiple_active_prescriptions: "safety.finding.multiple_active_prescriptions",
  conflicting_instructions: "safety.finding.conflicting_instructions",
};
