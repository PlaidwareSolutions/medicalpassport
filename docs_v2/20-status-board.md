...
| P2 Medication | started 2026-09-06 | **In progress** | Safety rules P2-3 done; schema (prescription items, refill plans, dispenses, reconciliation) applied in wave 2; API/UI next. Interaction categories **Blocked** on OD-4 |
