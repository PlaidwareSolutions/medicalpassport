...
export const GUIDANCE_AUDIO_ENTRIES = {
  ...
  // V2 screens (docs_v2/06 P1-5 "guidance audio regenerated"): every new
  // screen speaks pre-generated audio, not browser TTS, in all four locales.
  "screen.condition_hub": { sourceKeys: ["guide.screen.condition_hub"] },
  "screen.conditions": { sourceKeys: ["guide.screen.conditions"] },
  "screen.document_detail": { sourceKeys: ["guide.screen.document_detail"] },
  "screen.documents_review": { sourceKeys: ["guide.screen.documents_review"] },
  "screen.documents_new": { sourceKeys: ["guide.screen.documents_new"] },
  "screen.documents": { sourceKeys: ["guide.screen.documents"] },
  "screen.family_history": { sourceKeys: ["guide.screen.family_history"] },
  "screen.health": { sourceKeys: ["guide.screen.health"] },
  "screen.visits": { sourceKeys: ["guide.screen.visits"] },
  "screen.immunizations": { sourceKeys: ["guide.screen.immunizations"] },
  "screen.measurement_trend": { sourceKeys: ["guide.screen.measurement_trend"] },
  "screen.checkups": { sourceKeys: ["guide.screen.checkups"] },
  "screen.devices": { sourceKeys: ["guide.screen.devices"] },
  "screen.measurements": { sourceKeys: ["guide.screen.measurements"] },
  "screen.organizations": { sourceKeys: ["guide.screen.organizations"] },
  "screen.prescription_new": { sourceKeys: ["guide.screen.prescription_new"] },
  "screen.procedures": { sourceKeys: ["guide.screen.procedures"] },
  "screen.health_details": { sourceKeys: ["guide.screen.health_details"] },
  "screen.report_new": { sourceKeys: ["guide.screen.report_new"] },
  "screen.result_trend": { sourceKeys: ["guide.screen.result_trend"] },
  "screen.share_target": { sourceKeys: ["guide.screen.share_target"] },
  "screen.report_detail": { sourceKeys: ["guide.screen.report_detail"] },
  "screen.prescription_detail": { sourceKeys: ["guide.screen.prescription_detail"] },
  "screen.family": { sourceKeys: ["household.read_aloud"] },
  "screen.activity": { sourceKeys: ["activity.read_aloud"] },
  "screen.notifications": { sourceKeys: ["notify.read_aloud"] },
  "screen.share_new": { sourceKeys: ["share.new_read_aloud"] },
  "screen.documents_done": { sourceKeys: ["documents.done_body"] },
  "screen.proposals": { sourceKeys: ["proposals.title", "guide.screen.proposals"] },
  "screen.abha": { sourceKeys: ["abha.title", "guide.screen.abha"] },
  "screen.abha_care_contexts": { sourceKeys: ["abha.care_contexts_title", "abha.care_contexts_intro"] },
  "screen.abha_consents": { sourceKeys: ["abha.consents_title", "abha.consents_intro"] },
  "screen.abha_records": { sourceKeys: ["abha.records_title", "abha.records_intro"] },
  "screen.connections": { sourceKeys: ["connections.title", "guide.screen.connections"] },
  "screen.connections_code": { sourceKeys: ["connections.code_title", "connections.code_intro"] },
  "screen.discharge": { sourceKeys: ["documents.discharge_body_1", "documents.discharge_body_2"] },
