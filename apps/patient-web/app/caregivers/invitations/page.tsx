...
export default function CaregiverInvitationsPage() {
  ...
  return (
    <AppShell>
      <PageHeader title={t("caregiver.invitations_title")} readAloud={[{ audio: "screen.caregiver_invitations" }]} />
      ...
      {items && items.length === 0 ? (
        <EmptyState
          glyph="people"
          titleKey="caregiver.invitations_empty_title"
          bodyKey="caregiver.invitations_empty_body"
          audioId="empty.caregiver_invitations"
        />
      ) : null}
